...
CapQ = (function() {
  ...
  CapQ.prototype._rfix = function(element) {
    if (! this._pushable()) {
      return false;
    }
    if (this.full()) {
  ...
  CapQ.prototype._lfix = function(element) {
    if (! this._pushable()) {
      return false;
    }
    if (this.full()) {
  ...
  CapQ.prototype._rchuck = function() {
    if (this.empty()) {
      return this._null;
    }
  ...
  CapQ.prototype._lchuck = function() {
    if (this.empty()) {
      return this._null;
    }
  ...
  CapQ.prototype.rpush = function() {
    return this._pushArgs(arguments, this._rfix);
  };

  // Left-Push
  CapQ.prototype.lpush = function() {
    return this._pushArgs(arguments, this._lfix);
  };

  // Right-Pop
  CapQ.prototype.rpop = function(num) {
    return this._popMany(num, this._rchuck);
  };

  // Left-Pop
  CapQ.prototype.lpop = function(num) {
    return this._popMany(num, this._lchuck);
  };
